              ...
              for (var j, k = new c.Svg.Path().move(b[0], b[1], !1, g[0]), l = 0, m = b.length; m - 2 * !j > l; l += 2) {
                ...
                j
                  ? l
                    ? m - 4 === l
                      ? (n[3] = { x: +b[0], y: +b[1] })
                      : m - 2 === l && ((n[2] = { x: +b[0], y: +b[1] }), (n[3] = { x: +b[2], y: +b[3] }))
                    : (n[0] = { x: +b[m - 2], y: +b[m - 1] })
                  : m - 4 === l
                  ? (n[3] = n[2])
                  : l || (n[0] = { x: +b[l], y: +b[l + 1] }),
              ...
              if (f.length) {
                ...
                for (m[0] = n[0], m[l - 1] = n[l - 2], h = 1; h < l - 1; h++)
                  0 === n[h] || 0 === n[h - 1] || n[h - 1] > 0 != n[h] > 0
                    ? (m[h] = 0)
                    : ((m[h] = (3 * (p[h - 1] + p[h])) / ((2 * p[h] + p[h - 1]) / n[h - 1] + (p[h] + 2 * p[h - 1]) / n[h])),
                      isFinite(m[h]) || (m[h] = 0));
    ...
    (function (a, b, c) {
      ...
      function y(a) {
        ...
        Object.keys(c.Svg.prototype)
          .filter(function (a) {
            return (
              ['constructor', 'parent', 'querySelector', 'querySelectorAll', 'replace', 'append', 'classes', 'height', 'width'].indexOf(
                a
              ) === -1
            );
          })
      ...
      function d(a) {
        ...
        (k = a.distributeSeries && a.stackBars ? b.normalized.labels.slice(0, 1) : b.normalized.labels),
          a.horizontalBars
            ? ((j = m =
                void 0 === a.axisX.type
                  ? new c.AutoScaleAxis(c.Axis.units.x, b.normalized.series, o, c.extend({}, a.axisX, { highLow: d, referenceValue: 0 }))
                  : a.axisX.type.call(c, c.Axis.units.x, b.normalized.series, o, c.extend({}, a.axisX, { highLow: d, referenceValue: 0 }))),
              (l = n =
                void 0 === a.axisY.type
            ...
            : ((l = m =
              ...
              (j = n =
                void 0 === a.axisY.type
                  ? new c.AutoScaleAxis(c.Axis.units.y, b.normalized.series, o, c.extend({}, a.axisY, { highLow: d, referenceValue: 0 }))
                  : a.axisY.type.call(
                      c,
                      c.Axis.units.y,
                      b.normalized.series,
                  ...
                  function (g, k) {
                    ...
                    if (
                      ...
                      (s = h
                        ...
                        .attr({ 'ct:value': [g.x, g.y].filter(c.isNumeric).join(','), 'ct:meta': c.serialize(w) })),
            ...
            function (i) {
              ...
              function l(b) {
                ...
                if (j.appendToBody) (o.style.top = b.pageY + f + 'px'), (o.style.left = b.pageX + e + 'px');
                  ...
                  !0 === j.anchorToPoint &&
                    b.target.x2 &&
                    b.target.y2 &&
                    ((c = parseInt(b.target.x2.baseVal.value)), (d = parseInt(b.target.y2.baseVal.value))),
              ...
              e(o),
                k('mouseover', m, function (a) {
                  ...
                  if (
                    (j.transformTooltipTextFnc && 'function' == typeof j.transformTooltipTextFnc && (s = j.transformTooltipTextFnc(s)),
...
!(function (a, b) {
  ...
  return (
    (function (a) {
      'use strict';
      var b = { axisTitle: '', axisClass: 'ct-axis-title', offset: { x: 0, y: 0 }, textAnchor: 'middle', flipTitle: !1 },
        c = { axisX: b, axisY: b },
        d = function (a) {
      ...
      (a.plugins = a.plugins || {}),
        (a.plugins.ctAxisTitle = function (b) {
          return (
            (b = a.extend({}, c, b)),
            function (c) {
              c.on('created', function (c) {
                if (!b.axisX.axisTitle && !b.axisY.axisTitle)
                  throw new Error('ctAxisTitle plugin - You must provide at least one axis title');
                if (!c.axisX && !c.axisY) throw new Error('ctAxisTitle plugin can only be used on charts that have at least one axis');
                var f,
                  g,
                  h,
                  i = a.normalizePadding(c.options.chartPadding);
                if (
                  (b.axisX.axisTitle &&
                    c.axisX &&
                    ((f = c.axisX.axisLength / 2 + c.options.axisY.offset + i.left),
                    (g = i.top),
                    'end' === c.options.axisY.position && (f -= c.options.axisY.offset),
                    'end' === c.options.axisX.position && (g += c.axisY.axisLength),
                    (h = new a.Svg('text')),
                    h.addClass(e(b.axisX.axisClass)),
                    h.text(d(b.axisX.axisTitle)),
                    h.attr({ x: f + b.axisX.offset.x, y: g + b.axisX.offset.y, 'text-anchor': b.axisX.textAnchor }),
                    c.svg.append(h, !0)),
                  b.axisY.axisTitle && c.axisY)
                ) {
                  (f = 0),
                    (g = c.axisY.axisLength / 2 + i.top),
                    'start' === c.options.axisX.position && (g += c.options.axisX.offset),
                    'end' === c.options.axisY.position && (f = c.axisX.axisLength);
                  var j = 'rotate(' + (b.axisY.flipTitle ? -90 : 90) + ', ' + f + ', ' + g + ')';
                  (h = new a.Svg('text')),
                    h.addClass(e(b.axisY.axisClass)),
                    h.text(d(b.axisY.axisTitle)),
                    h.attr({ x: f + b.axisY.offset.x, y: g + b.axisY.offset.y, transform: j, 'text-anchor': b.axisY.textAnchor }),
                    c.svg.append(h, !0);
                }
              });
            }
